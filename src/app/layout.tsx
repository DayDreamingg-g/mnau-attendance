...
import './globals.css';
export const metadata:Metadata={title:{default:'MNAU Attendance',template:'%s · MNAU Attendance'},description:'Демонстраційна система обліку відвідуваності МНАУ',robots:{index:false,follow:false}};
